...
<nav class="navbar navbar-inverse  ">
    <ul class="nav navbar-nav">
      <li class = "{{set_active('/')}}"><a href="{{ URL::to('') }}">Home</a></li>
        <li class = "{{set_active('getting_start')}}"><a href="{{ URL::to('getting_start') }}">Getting Start</a></li>
        <li class = "{{set_active('simulation')}}"><a href="{{ URL::to('simulation') }}">Simulation</a></li>
